...
# Get the source code from cell 3
cell_3_source = ''.join(data['cells'][3]['source'])

# Define the new source code with enhanced error handling
new_source = '''# Define dataset paths
...
data['cells'][3]['source'] = new_source.split('\n')

# Write the modified data back to the file
with open('task2_notebook/task2_improved.ipynb', 'w') as f:
    json.dump(data, f, indent=1)

print("Successfully modified the brands data loading code in cell 3")
